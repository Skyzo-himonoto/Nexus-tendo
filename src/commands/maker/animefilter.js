...
export default async function animefilter(context) {
  ...
  if (!isImage) {
    return await sock.sendMessage(sender, {
      text: '📝 *Cara penggunaan:*\nReply gambar dengan .animefilter\n\n🎨 *Ubah foto jadi gaya anime!*'
    });
  }
  
  await sock.sendMessage(sender, { text: '🎨 *Mengubah gambar ke gaya anime...*\nMohon tunggu sebentar.' });
  ...
  try {
    ...
    const response = await axios.post('https://api.ryzendesu.vip/api/maker/animefilter', formData, {
