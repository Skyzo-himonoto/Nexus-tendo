...
export default async function islam(context) {
  ...
  try {
    if (subCommand === 'quran') {
      if (params.length === 0) {
        return await sock.sendMessage(sender, { text: '📝 *Contoh:* .islam quran 1:1' });
      }
      ...
      if (params.length === 0) {
        return await sock.sendMessage(sender, { text: '📝 *Contoh:* .islam jadwal jakarta' });
      }
...
╰━━━━━━━━━━━━━━━━━━━╯`;
      ...
      if (params.length === 0) {
        return await sock.sendMessage(sender, { text: '📝 *Contoh:* .islam doa sebelum makan' });
      }
...
╰━━━━━━━━━━━━━━━━━━━╯`;
      ...
      await sock.sendMessage(sender, {
        text: `❌ Sub command *${subCommand}* tidak dikenal!\n\nGunakan: quran, jadwal, doa, asmaulhusna`
      });
    }
