...
export default async function category(context) {
  ...
  const categories = {
    ...
    game: { name: '🎮 GAMES', commands: ['game', 'jawab', 'gamelist', 'suit', 'tebakangka'] },
    maker: { name: '🎨 MAKER', commands: ['carbon', 'neon', 'glitch', 'burn', 'wanted', 'rip', 'rainbow', '3dtext'] },
    tools: { name: '🛠️ TOOLS', commands: ['qrcode', 'tts', 'translate', 'styletext', 'calc', 'shorturl', 'weather', 'whois', 'afk', 'report', 'runtime', 'url2img'] },
